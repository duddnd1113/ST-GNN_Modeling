import logging
from TSPTopKTrainer import TSPTopKTrainer as Trainer
...
env_params = {
    # Training now uses random TSP(top_k) instances directly.
    # Real 18,000-grid top-k selection happens only during solve_real_csv/inference.
